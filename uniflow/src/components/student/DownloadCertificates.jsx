    ...
    const mockCertificates = [
      {
        ...
        issuedBy: 'Tech Club, JNTU Hyderabad',
        certificateNumber: 'HK24-WIN-001',
        validationUrl: 'https://uniflow.edu/verify/CERT-2024-001',
        downloadUrl: '/certificates/hackathon-2024-winner.pdf',
        status: 'issued',
        attendance: 100,
        description: 'First Prize Winner in 24-hour Hackathon Competition'
      },
      {
        id: 'CERT-2024-002',
        ...
        certificateNumber: 'WS24-PAR-045',
        validationUrl: 'https://uniflow.edu/verify/CERT-2024-002',
        downloadUrl: '/certificates/aiml-workshop-participation.pdf',
        status: 'issued',
        attendance: 75,
        description: '4-day intensive workshop on Artificial Intelligence and Machine Learning'
      },
      {
        id: 'CERT-2024-003',
        ...
        certificateNumber: 'CF24-PAR-128',
        validationUrl: 'https://uniflow.edu/verify/CERT-2024-003',
        downloadUrl: '/certificates/cultural-fest-participation.pdf',
        status: 'issued',
        attendance: 100,
        description: 'Active participation in Cultural Fest 2024'
      },
      {
        id: 'CERT-2024-004',
        ...
        issuedBy: 'NSS Unit, JNTU Hyderabad',
        certificateNumber: 'BD24-APP-089',
        validationUrl: 'https://uniflow.edu/verify/CERT-2024-004',
        downloadUrl: '/certificates/blood-donation-appreciation.pdf',
        status: 'issued',
        attendance: 100,
        description: 'Certificate of Appreciation for voluntary blood donation'
      },
      {
        id: 'CERT-2024-005',
        ...
        issuedBy: 'Tech Club',
        certificateNumber: 'TT24-PAR-067',
        validationUrl: 'https://uniflow.edu/verify/CERT-2024-005',
        downloadUrl: '/certificates/tech-talk-participation.pdf',
        status: 'issued',
        attendance: 80,
        description: 'Participation in 5-session Tech Talk Series on emerging technologies'
      },
      {
        id: 'CERT-2024-006',
        ...
        date: '2024-11-10',
        issuedDate: null,
        issuedBy: 'Technical Club',
        certificateNumber: null,
        validationUrl: null,
        downloadUrl: null,
        status: 'pending',
        attendance: null,
        description: 'Certificate will be issued after event completion and attendance verification'
      }
    ];
